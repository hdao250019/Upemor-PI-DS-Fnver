...
public class SplashFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(65, 67, 159));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SplashFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
